...
function CurrentProjects() {
  ...
  const [professionals, setProfessionals] = useState([
    { id: 1, name: 'Project 1', description: 'Goog1' },
    { id: 2, name: 'Project 2', description: 'Goog2' },
    { id: 3, name: 'Project 3', description: 'Goog3' },
  ]);
              ...
              <List>
                {Object.keys(professionals).map((projectKey) => (
                  <Paper key={projectKey} sx={{ marginBottom: '10px', padding: '10px' }}>
                    ...
                    <Link to="/logprogress" style={{ textDecoration: 'none', color: '#333' }}>
                      <Button variant="contained" color="primary" navigate="/logprogress">
                        Log Progress
                      </Button>
                    </Link>
                  </Paper>
